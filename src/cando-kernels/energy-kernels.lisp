...
(defkernel *chiral-restraint*
  (:c-function-name chiral_restraint_kernel)
...
(defkernel *anchor-penalty-kernel*
  (:c-function-name anchor_penalty)
  (:compute (energy grad hess))
  (:pipeline *pipeline*)
  (:layout ((1 . I3X1))
            ((X . 0) (Y . 1) (Z . 2)))
...
(defkernel *dihedral-harmonic-restraint*
  (:c-function-name dihedral_harmonic_restraint_kernel)
...
(defun write-all (pathname)
  (loop for kernel in (list
                       ...
                       *chiral-restraint*
                       *anchor-penalty-kernel*
                       *dihedral-harmonic-restraint*
                       )
